...
* Install MySQL Connector/Python
    - on the command line: `pip install mysql-connector-python`
* Create a python script that initializes a SQLite database and creates a table `movies`. You can start with `exercise0.py`
...
Alternatively, you can just execute the `movies.sql` script


## Exercise #1: Listing movies

Folder [ex_1](ex_1) contains the solution for Exercise 4 from the last lecture.
Update the site, such that movies are loaded from the mysql database.
